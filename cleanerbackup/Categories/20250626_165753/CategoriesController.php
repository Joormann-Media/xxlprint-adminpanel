...
final class CategoriesController extends AbstractController
{
    ...
    #[Route('/{id<\d+>}', name: 'app_categories_show', methods: ['GET'])]
    ...
    #[Route('/{id<\d+>}/edit', name: 'app_categories_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id<\d+>}', name: 'app_categories_delete', methods: ['POST'])]
