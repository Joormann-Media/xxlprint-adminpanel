...
final class BlogCategoryController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $form = $this->createForm(BlogCategoryForm::class, $blogCategory);
    ...
    #[Route('/{id<\d+>}', name: 'app_blog_category_show', methods: ['GET'])]
    ...
    #[Route('/{id<\d+>}/edit', name: 'app_blog_category_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id<\d+>}', name: 'app_blog_category_delete', methods: ['POST'])]
