...
final class AttachmentController extends AbstractController
{
    ...
    #[Route('/{id<\d+>}', name: 'app_attachment_show', methods: ['GET'])]
    ...
    #[Route('/{id<\d+>}/edit', name: 'app_attachment_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id<\d+>}', name: 'app_attachment_delete', methods: ['POST'])]
