...
final class ConversationController extends AbstractController
{
    ...
    #[Route('/{id<\d+>}', name: 'app_conversation_show', methods: ['GET'])]
    ...
    #[Route('/{id<\d+>}/edit', name: 'app_conversation_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id<\d+>}', name: 'app_conversation_delete', methods: ['POST'])]
