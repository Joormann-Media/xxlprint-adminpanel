...
final class StatisticsController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $form = $this->createForm(StatisticsForm::class, $statistic);
    ...
    #[Route('/{id<\d+>}', name: 'app_statistics_show', methods: ['GET'])]
    ...
    #[Route('/{id<\d+>}/edit', name: 'app_statistics_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id<\d+>}', name: 'app_statistics_delete', methods: ['POST'])]
